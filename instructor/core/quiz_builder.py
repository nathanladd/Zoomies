...
class QuizBuilder(QWidget):
    ...
    def _build_ui(self):
        ...
        self.quiz_table.horizontalHeader().setSectionResizeMode(1, QHeaderView.ResizeMode.Stretch)
        ...
        self.q_table.horizontalHeader().setSectionResizeMode(3, QHeaderView.ResizeMode.Stretch)
